  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-pink-50 via-white to-orange-50 flex items-center justify-center p-4 relative overflow-hidden">
      ...
      >
        ...
        >
          <h2 className="text-2xl font-bold text-gray-900 mb-6">Sign In with Google</h2>
          ...
          <motion.div whileHover={{ scale: 1.02 }} whileTap={{ scale: 0.98 }}>
            <Button
              ...
              className="w-full py-6 text-lg font-semibold rounded-xl shadow-lg hover:shadow-2xl transition-all bg-white hover:bg-gray-50 text-gray-800 border-2 border-gray-200"
            >
